    ...
    <div>
        ...
        <div>
            <el-table :data="tableData.rows"
                ...
                <el-table-column  label="班级"  prop="user_class" ></el-table-column>
                <el-table-column  label="分院"  prop="yard" ></el-table-column>
                <el-table-column  label="咨询内容"  prop="content" ></el-table-column>
                <el-table-column  label="咨询时间"  prop="createdtime" ></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            searchData(){
                ...
                this.$http.getChawUser(param).then(res =>{
                    this.loading = false;
                    if(res.code == 0){
                        console.log(res)
                ...
                this.$http.getUser({id:window.localStorage.getItem('id')}).then(res =>{
                    ...
                    if(res.code == 0){
                        ...
                        this.config={
                            ...
                            name:this.currentRow.user_class+"（"+this.currentRow.name+"）"
                        }
                    }
                })
            },
